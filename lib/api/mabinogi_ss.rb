...
class API::MabinogiSS
  INDEX_URL  = 'http://www.mabinogi.jp/6th/community/ssBoardList.asp?p=%s'
  DETAIL_URL = 'http://www.mabinogi.jp/6th/community/ssBoardContent.asp?ix=%s'
